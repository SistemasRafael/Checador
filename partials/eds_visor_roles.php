    ...
    function actualiza($fecha_ini, $fecha_fin, $mina)
        {
            ...
            var cadena = fecha_ini+'&fecha_fin='+fecha_fin+'&mina='+mina+'&inf=3';
    ...
    function expo($fecha_ini, $fecha_fin, $unidad_mina)
        {
            ...
            var print_d = '<?php echo "eds_visor_roles_exp.php?fecha_ini="?>'+cadena;  
            //alert (print_d);              
                    window.location.href = print_d;
            }
...
$fecha_fin = $_GET['fecha_fin'];
    ...
    $sql = "EXEC [BiostarData_TA].[dbo].[_proc_marcajes_roles] '".$fecha_ini."','".$fecha_fin."',".$unidad_mina;
    ...
    <div class="col-md-12 col-lg-12"> 
        ...
        <div class="col-md-12 col-lg-12">
         ...
         <form method="post" action="app.php?fecha_ini=<?echo $fecha_ini."&fecha_fin=".$fecha_fin."&mina=".$unidad_mina."&inf=".$inf."";?>" name="visor" id="visor">  
                <fieldset>                                                
     ...
     ?>
         <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="container-fluid">
                        ...
                        <div class="col-md-2 col-lg-2">
                                <input type="submit" class="btn btn-info" name="export" id="export" value="Exportar" onclick= "expo(<?echo "'".$fecha_ini."', '".$fecha_fin."',".$unidad_mina;?>);" readonly />
                         </div>
                         <br/> 
                       </div>     
              </div>
         ...
         <br /> 
     <?
    $html_en = "<table class='table table-bordered' style='font-size:13px'  id='encabezado'>
                             <thead>
                                 <tr class='table-info'>  
    ...
    //for($i = 1; $i<$row_count; $i++){
      ...
      while( $row = sqlsrv_fetch_array( $eds_datos) ) {
            ...
            $row = eliminar_acentos($row);
                              ...
                              $html_en .= "<td>".$row['entrada']."</td>";
                              $html_en .= "<td>".$row['hr_ent_jor']."</td>";
                              $html_en .= "</tr>";
                             // $html_en .= "</tbody></table>";
