...
<nav class="navbar navbar-expand-xl navbar-dark bg-white">
      ...
      <a class="navbar-brand logos" href="eds_visor_val.php">
...
//echo $empleado;
    ...
    <div class="col-md-12 col-lg-12"> 
        ...
        <div class="col-md-12 col-lg-12">
         ...
         <form method="post" action="eds_visor_val.php?fecha_ini=<?echo $fecha_ini."&fecha_fin=".$fecha_fin."&mina=".$unidad_mina."&empleado=".$empleado."";?>" name="visor" id="visor">  
                <fieldset>                                                
            ...
            <div class="col-md-12 col-lg-12">
                <div class="container-fluid">
                        ...
                        <div class="col-xl-2 col-sm-2 col-md-2 col-ld-2 ">
                              <div class="card text-white text-lg-center bg-success o-hidden h-50">
                                <div class="card-body">
