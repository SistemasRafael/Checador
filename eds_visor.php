...
<nav class="navbar navbar-expand-xl navbar-dark bg-white">
      ...
      <a class="navbar-brand logos" href="dashboard.php">
        <img src="images/argonaut-logo2.jpg" alt="ArgonautGold Logo">
      </a>
      </div>
      <div class="col md-4 lg-4"> 
        <h3><b><?echo 'VISTA DE MARCAJES'?></b></h3>
      </div>
      <div class="col md-2 lg-2"> </div>
    ...
    function actualiza($fecha_ini, $fecha_fin, $mina, $empleado)
        {
            ...
            var print_d = '<?php echo "eds_visor.php?fecha_ini="?>'+cadena; 
    ...
    function expo($fecha_ini, $fecha_fin, $unidad_mina, $empleado)
        {
            ...
            var cadena = fecha_ini+'&fecha_fin='+fecha_fin+'&mina='+mina+'&empleado='+empleado;
            var print_d = '<?php echo "eds_visor_exportV2.php?fecha_ini="?>'+cadena;  
            //alert (print_d);              
                    window.location.href = print_d;
            }
...
//echo $empleado;
    ...
    <div class="col-md-12 col-lg-12"> 
        ...
        <div class="col-md-12 col-lg-12">
         ...
         <form method="post" action="eds_visor.php?fecha_ini=<?echo $fecha_ini."&fecha_fin=".$fecha_fin."&mina=".$unidad_mina."&empleado=".$empleado."";?>" name="visor" id="visor">  
                <fieldset>                                                
         ...
         <div class="row">
            <div class="col-md-12 col-lg-12">
                <div class="container-fluid">
                        ...
                        <div class="col-md-2 col-lg-2">
                                <input type="submit" class="btn btn-info" name="export" id="export" value="Export" onclick= "expo(<?echo "'".$fecha_ini."', '".$fecha_fin."',".$unidad_mina.",'".$empleado."'"?>);" readonly />
                         </div> 
                         
                        <div class="col-xl-2 col-sm-2 col-md-2 col-ld-2 ">
                              <div class="card text-white text-xs-center bg-success o-hidden h-50">
                                <div class="card-body">
                                  <div class="card-body-icon small">
